      ...
      <div className="bus-connections">
        ...
        <div className={`connection data-bus ${dataBus.active ? 'active' : ''}`}>
          ...
          <div className="connection-path">
            {dataBus.active && (
              <div className="data-flow" style={{ '--data-value': `'${dataBus.value || '0000000000000000'}'` }} />
            )}
          </div>
        ...
        <div className={`connection address-bus ${addressBus.active ? 'active' : ''}`}>
          <div className="connection-label">Bus de Dirección (12 bits)</div>
          <div className="connection-path">
            {addressBus.active && (
              <div className="address-flow" style={{ '--address-value': `'${addressBus.value || '000000000000'}'` }} />
            )}
          </div>
          <div className="connection-endpoints">
            <span className="endpoint cpu">CPU</span>
        ...
        <div className={`connection control-bus ${controlBus.active ? 'active' : ''}`}>
          ...
          <div className="connection-path">
            {controlBus.active && (
              <div className="control-flow" style={{ '--control-value': `'${controlBus.value || '0000'}'` }} />
            )}
          </div>
          <div className="connection-endpoints">
            <span className="endpoint cpu">CPU</span>

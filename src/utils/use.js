...
const useInstructionCycle = (systemState, setSystemState, handleOutput) => {
      ...
      switch(newState.currentStep) {
        ...
        case CPU_STEPS.EXECUTE:
          ...
          switch(opcode) {
            ...
            case '0010': // STORE
              { const storeAddress = fromBinary(address);
              newState.memory.ram[storeAddress] = newState.cpu.registers.ACC;
              newState.cpu.registers.MAR = address;
              newState.buses.address = {
                ...newState.buses.address,
                value: address,
              ...
              newState.buses.data = {
                ...newState.buses.data,
                value: newState.cpu.registers.ACC,
                active: true,
                source: 'cpu'
              };
              break; }
  ...
  }, [systemState.running, executeNextInstruction]);
